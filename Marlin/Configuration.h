...
#define STRING_CONFIG_H_AUTHOR "(Alex Marcos)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Loww Rider"
...
#define Y_MAX_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop.  // This is Y2 min
...
// #define FTDI_CUSTOM_USER_MENUS 1
...
//Disable warning in build to warn about the fact that Y2 and Z2 were auto assigned in the spot of En 
#define NO_AUTO_ASSIGN_WARNING


// Disable warning about the diag jumpers that need to be removed from the board when we don't want sensorless homing
